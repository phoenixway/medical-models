 ...
 * ➡️ Якщо АТ залишається низьким після цього → Перейти до початку [[areas/health-n-healing/medical-models/shock/vasopressory-therapy/vasopressory-therapy]] (як у Під-сценарії А1).
